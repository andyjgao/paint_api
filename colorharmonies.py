...
def complementaryColor(ColorInput):
	...
	ColorInput.HLS = list(colorsys.rgb_to_hls(ColorInput.RGB[0] / 255.0, ColorInput.RGB[1] / 255.0, ColorInput.RGB[2] / 255.0))
...
def triadicColor(ColorInput):
	...
	FirstTriadicHue = ((ColorInput.HLS[0] * 360 + 120) % 360) / 360.0

	# Find the second triadic Hue
	SecondTriadicHue = ((ColorInput.HLS[0] * 360 + 240) % 360) / 360.0
...
def splitComplementaryColor(ColorInput):
	...
	# Find the first triadic Hue
	FirstSplitComplementaryHue = ((ColorInput.HLS[0] * 360 + 150) % 360) / 360.0

	# Find the second triadic Hue
	SecondSplitComplementaryHue = ((ColorInput.HLS[0] * 360 + 210) % 360) / 360.0
...
def tetradicColor(ColorInput):
	...
	FirstTetradicHue = ((ColorInput.HLS[0] * 360 + 60) % 360) / 360.0

	# Find the second tetradic Hue
	SecondTetradicHue = ((ColorInput.HLS[0] * 360 + 180) % 360) / 360.0

	# Find the third tetradic Hue
	ThirdTetradicHue = ((ColorInput.HLS[0] * 360 + 240) % 360) / 360.0
...
def analogousColor(ColorInput):
	...
	FirstAnalogousHue = ((ColorInput.HLS[0] * 360 + 30) % 360) / 360.0

	# Find the second analogous Hue
	SecondAnalogousHue = ((ColorInput.HLS[0] * 360 - 30) % 360) / 360.0
...
def monochromaticColor(ColorInput):
	...
	ColorInput.HSV = list(colorsys.rgb_to_hsv(ColorInput.RGB[0] / 255.0, ColorInput.RGB[1] / 255.0, ColorInput.RGB[2] / 255.0))
